...
const Navbar = ({ navItems }) => (
  <div>
    {/* Desktop */}
    <nav className="fixed z-10 w-screen hidden sm:block bg-grey-800 font-headline font-light uppercase p-2">
    ...
    {/* Mobile */}
    <nav className="fixed z-10 w-screen flex sm:hidden flex-col items-center bg-grey-800 font-headline font-light uppercase">
